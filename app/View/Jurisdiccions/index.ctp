<div class="jurisdiccions index">
	<h2><?php echo __('Jurisdiccions'); ?></h2>
	...
	<tbody>
	<?php foreach ($jurisdiccions as $jurisdiccion): ?>
	<tr>
		<td><?php echo h($jurisdiccion['Jurisdiccion']['id']); ?>&nbsp;</td>
		<td><?php echo h($jurisdiccion['Jurisdiccion']['nombre']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $jurisdiccion['Jurisdiccion']['id']), array(), __('Are you sure you want to delete # %s?', $jurisdiccion['Jurisdiccion']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
